...
<div id="dialog"></div>
          ...
          <div class="thread-item-root">
            <label class="thread-item">[<?php echo $cat_name;?>]No.<?php echo $thr_no;?></label>
            <label class="thread-item"><?php echo h_escape($thr_info['thr_title']);?> </label>
              ...
              <div class="posted posted-container">
               <label class="posted-item-1">No.<?php echo $val['pos_id'];?> <?php echo h_escape($val['pos_penname']);?> <?php echo date('Y年m月d日 H:i',strtotime($val['pos_created']));?></label>
                ...
                <label class="posted-item-1">
                  ...
                  <input type="text" name="password_<?php echo $thr_no;?>_<?php echo $val['pos_id'];?>" cat_name="<?php echo $cat_name;?>" 
